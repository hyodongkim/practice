...
public interface ICookDao {
	...
	public int addCook(String cook_Title, String cook_Writer, String cook_Company, String filename,
			String cook_Content, String cook_Introduce, int cook_Category);
 
    public int updateCook( int cook_Index, String cook_Title, String cook_Writer, String cook_Company, String filename,
			String cook_Content, String cook_Introduce, int cook_Category);
